...
def main() -> None:
    root = Path(__file__).resolve().parents[1] / "src/main/resources/assets/boostermod"
    out_dir = root / "textures/item"
    tiers = [
        ("booster_leggings_wood", (0x6E, 0x4A, 0x23), (0xA5, 0x70, 0x33), (0xD5, 0xA6, 0x6B), (0x3D, 0x28, 0x11)),
        ("booster_leggings_stone", (0x6E, 0x4A, 0x23), (0x8A, 0x8A, 0x8A), (0xC0, 0xC0, 0xC0), (0x3C, 0x3C, 0x3C)),
        ("booster_leggings_copper", (0x6E, 0x4A, 0x23), (0xC4, 0x6B, 0x43), (0xF0, 0xA5, 0x7C), (0x5A, 0x2C, 0x18)),
        ("booster_leggings_iron", (0x6E, 0x4A, 0x23), (0xD8, 0xD8, 0xD8), (0xFF, 0xFF, 0xFF), (0x5C, 0x5C, 0x5C)),
        ("booster_leggings_gold", (0x6E, 0x4A, 0x23), (0xF9, 0xD7, 0x4A), (0xFF, 0xF5, 0xB0), (0x8A, 0x6A, 0x12)),
        ("booster_leggings_diamond", (0x6E, 0x4A, 0x23), (0x5E, 0xDB, 0xD3), (0xB8, 0xFF, 0xFA), (0x1F, 0x6F, 0x69)),
        ("booster_leggings_netherite", (0x6E, 0x4A, 0x23), (0x4A, 0x41, 0x44), (0x7A, 0x6D, 0x70), (0x1B, 0x15, 0x17)),
    ]
